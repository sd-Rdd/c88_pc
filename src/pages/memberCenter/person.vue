  ...
  <div>
      ...
      <div class="left">
        ...
        <div class="right user_info">
          <ul>
            ...
            <li>
              <label for="login_time">登录时间：</label> {{getLoginData.finallyLoginTime}} </li>
          </ul>
        </div>
      </div>
      <div class="right">
        <div class="account_info">
          ...
          <div class="account_topup">
            <router-link class="btn btn-default topup-btn user_goto_recharge" to="/memberCenter/caiwu/1">充值</router-link>
    ...
    <MemberCommon>
      ...
      <div slot="body">
        <div v-show="safe==1">
          <div class="safe_item">
            <div class="accordion-header" @click="isShow('a')">
              <div class="safe_item_head login_password pointer">
                <div class="left info_view">
                  <i class="iconfont icon-mima1"></i>
                  <div class="left">
                    <h3>登录密码</h3>
                    <span>定期更换密码，让您的账户更安全</span>
                  </div>
                </div>
                <div class="right tool_control">
                  ...
                  <div class="form">
                    <form id="changePwdFrom" autocomplete="off">
                      <div class="form_group">
                        <input type="password" placeholder="请输入旧密码" v-model="logPSW.oldPassword" @blur="checkLoginPsw('oldPassword')" autocomplete="new-password">
                      </div>
                      <div class="form_group">
                        <input type="password" placeholder="请输入新密码" v-model="logPSW.newPassword1" @blur="checkLoginPsw('newPassword1')" autocomplete="new-password">
                      </div>
                      <div class="form_group">
                        <input type="password" placeholder="请再次确认新密码" v-model="logPSW.newPassword2" @blur="checkLoginPsw('newPassword2')" autocomplete="new-password">
                      </div>
          ...
          <div class="safe_item" id="fund_password_item">
            <div class="accordion-header" @click="isShow('b')">
              <div class="safe_item_head login_password pointer">
                ...
                <div class="left info_view">
                  ...
                  <div class="left">
                    <h3>资金密码</h3>
                    <span>为您账户安全，真实姓名要与绑定银行卡姓名一致</span>
                  </div>
                </div>

                <div class="right tool_control" v-if="pword==0">
                  <div class="tool_group" id="set_two">
                ...
                <div class="right tool_control" v-if="pword==1">
                  <div class="tool_group">
                    <i class="iconfont icon-Selected"></i>
                    <span>已设置</span>
                  </div>
              ...
              <div class="safe_item_body accordion-content" v-show="show.b" id="fund_password_body">
                <div class="change_password" v-if="pword==0">
                  <div class="form" autocomplete="off">
                    <form id="changeTradePwdFrom">
                      <div class="form_group">
                        <input type="password" placeholder="请设置资金密码" @blur="checkzijinPsw('firstZinjin','firstZinjin')" v-model="firstZinjin.firstZinjin">
                      </div>
                      <div class="form_remark">
                        密码规则：
                ...
                <div class="change_password" v-if="pword==1">
                  <div class="form">
                    <form id="changePwdFrom" autocomplete="off">
                      <div class="form_group">
                        <input type="password" placeholder="请输入当前资金密码" v-model="secondZinjin.oldPassword" @blur="checkzijinPsw('secondZinjin','oldPassword')" autocomplete="new-password">
                      </div>
                      <div class="form_group">
                        <input type="password" placeholder="请输入新资金密码" v-model="secondZinjin.newPassword1" @blur="checkzijinPsw('secondZinjin','newPassword1')" autocomplete="new-password">
                      </div>
                      <div class="form_group">
                        <input type="password" placeholder="请再次确认新资金密码" v-model="secondZinjin.newPassword2" @blur="checkzijinPsw('secondZinjin','newPassword2')" autocomplete="new-password">
                      </div>
                    ...
                    <form id="bindBankCardFrom" method="post" autocomplete="off">
                      ...
                      <div class="form_group">
                        <select class="select select_k" v-model="bankInfo.bankCatId" id="bank_id">
                          ...
                          <option :value="item.id" v-for="(item,index) in bankList" :key="index">{{item.bankName}}</option>
                        </select>
                      </div>
                ...
                <table class="safe_info_table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="wid">
                        {{getLoginData.finallyLoginAddr}} </td>
                      <td class="tit">上一次登录地点</td>
                      <td class="wid">
                        {{getLoginData.lastLoginAddr}} </td>
                    </tr>
                    <tr>
                      <td class="tit">注册时间</td>
                      <td class="wid">
                        {{getLoginData.registerTime}} </td>
                      <td class="tit">注册IP</td>
                      <td class="wid">
                        {{getLoginData.registerIp}} </td>
                    </tr>
                  </tbody>
                </table>
              </div>
