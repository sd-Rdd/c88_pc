    ...
    <div class="lottery-main">
        ...
        <div class="right-part">
          <div class="right-part-c">
            <bet-select-play :play="pk10" :firstDefault="stairCodeNo" :secondDefault="defaultCodeNo"></bet-select-play>
            <div class="bet-area">
              <bet-tips></bet-tips>
              <div class="bet-main">
...
export default {
  ...
  methods: {
    getData() {
      this.$store
        .dispatch("getLotteryData", { this: this, data: { lotteryNo: "41",memberId: tools.store.getData("user").id } })
        .then(res => {
      ...
      /* 向vuex中发送彩种编号 */
      this.$store.commit("changeLotteryCode", { a: "41" });
    }
  },
  created() {
    this.getData();
