    ...
    <div class="lottery-main">
        ...
        <div class="right-part">
          <div class="right-part-c">
            <bet-select-play :play="dipin" :firstDefault="stairCodeNo" :secondDefault="defaultCodeNo"></bet-select-play>
            <div class="bet-area">
              <bet-tips></bet-tips>
              <div class="bet-main">
    ...
    getData() {
      this.$store
        .dispatch("getLotteryData", {
          this: this,
          data: { lotteryNo: "101",memberId: tools.store.getData("user").id }
        })
        .then(res => {
      ...
      /* 向vuex中发送彩种编号 */
      this.$store.commit("changeLotteryCode", { a: "101" });
    }
  },
  created() {
    this.getData();
