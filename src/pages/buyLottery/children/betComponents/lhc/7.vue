<template>
  <div class="lhc-bet-area">
    ...
    <div class="lianma-area">
      <div class="balls-grid">
        <div class="row title">
          <div class="cell" style="width: 20%;">
            <div class="number" style="width: 50%; color: rgb(51, 51, 51);">号码</div>
            <div class="select" style="width: 50%; color: rgb(51, 51, 51);">勾选</div>
          </div>
          <div class="cell" style="width: 20%;">
            <div class="number" style="width: 50%; color: rgb(51, 51, 51);">号码</div>
            <div class="select" style="width: 50%; color: rgb(51, 51, 51);">勾选</div>
        ...
        <div class="row">
          ...
          <div class="cell" style="width: 20%;">
            ...
            <div class="select" style="width: 50%;"></div>
          </div>
        </div>
      </div>
      <!-- 结果开始 -->
...
export default {
  ...
  computed: {
    ...
    SumGroup() {
      if (this.currentIndex == 0) {
        return tools.combination(4, this.count);
      } else if (this.currentIndex == 1 || this.currentIndex == 2) {
        return tools.combination(3, this.count);
      } else if (
        this.currentIndex == 3 ||
        this.currentIndex == 4 ||
        this.currentIndex == 5
      ) {
        return tools.combination(2, this.count);
      }
    },
    //组装成列表里显示的样子的数据格式
    LikeSumlist() {
      ...
      let erweiArr;
      if (this.currentIndex == 0) {
        erweiArr=tools.choose(this.NumberArr,4)
      } else if (this.currentIndex == 1 || this.currentIndex == 2) {
         erweiArr=tools.choose(this.NumberArr,3)
      } else if (
        this.currentIndex == 3 ||
        this.currentIndex == 4 ||
        this.currentIndex == 5
      ) {
         erweiArr=tools.choose(this.NumberArr,2)
      }
      /* 第二部：组装成列表里显示的数据格式 */
      let LikeSumlist2=[];
      erweiArr.forEach(item=>{
          let obj={};
          obj.mode=this.sublotteryCode.sixOdds[this.currentIndex].name;
          obj.number=item;
          obj.odds=this.sublotteryCode.sixOdds[this.currentIndex].odds;
  ...
  //此处使用深度监控原因是取消选择的时候也要监控到，普通监控做不到
  watch: {
    moreCheck: {
